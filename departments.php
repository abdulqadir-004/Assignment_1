...
$locations = getTableData($pdo, 'locations');
                ...
                <form id="addForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="data[department_id]" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Department Name</label>
                            <input type="text" class="form-control" name="data[department_name]" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="data[location_id]">
                                <option value="">No Location</option>
                                <?php foreach($locations as $loc): ?>
                                    <option value="<?php echo $loc['location_id']; ?>"><?php echo htmlspecialchars($loc['city'] . ', ' . $loc['country_id']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
