...
<head>
    ...
    <title>Regions - HR Management System</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-globe me-2"></i>Regions</h2>
                ...
                <form id="addForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="data[region_id]" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Region Name</label>
                            <input type="text" class="form-control" name="data[region_name]" required>
                        </div>
                    </div>
