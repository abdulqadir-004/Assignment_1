...
$countries = getTableData($pdo, 'countries');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Locations - HR Management System</title>
                ...
                <form id="addForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="data[location_id]" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Street Address</label>
                            <input type="text" class="form-control" name="data[street_address]">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Postal Code</label>
                            <input type="text" class="form-control" name="data[postal_code]">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">City</label>
                            <input type="text" class="form-control" name="data[city]" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">State/Province</label>
                            <input type="text" class="form-control" name="data[state_province]">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Country</label>
                            <select class="form-select" name="data[country_id]" required>
